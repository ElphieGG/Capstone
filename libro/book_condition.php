...
<i class="fas fa-book-open"></i>
  <span>LibroCompartir</span>
    ...
    <h2 class="mb-4 d-flex justify-content-between">
       ...
       &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
       &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
       <button class="btn-action"><a href="add_book_condition.php" style="color: white; text-decoration: none;">Add Book Condition</a></button>
    ...
    <div class="table-responsive">
        <table id="booksTable" class="table table-striped table-hover">
            ...
            <tbody>
                ...
                $sql = "SELECT condition_id, book_condition 
                        FROM tblbook_condition";
                ...
                if ($result->num_rows > 0) {
                    ...
                    echo "<tr><td colspan='7' class='text-center'>No category found</td></tr>";
                }
...
function printBooksReport() {
    ...
    document.body.innerHTML = brandLogo + "<h2>Book Condition Report</h2>" + printContent;
    window.print();
