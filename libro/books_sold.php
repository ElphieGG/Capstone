...
// Query to fetch books where book_status is "Sold"
$sql = "SELECT b.id, b.title, b.description, b.category, b.book_condition, b.book_status, b.image, 
        ...
        WHERE b.book_status = 'Sold'";  // Filter for only Sold books
...
if ($result->num_rows > 0) {
   ...
   //     echo "<a class='btn btn-danger btn-sm' href='delete_booksold_admin.php?id=" . $row['id'] . "' onclick='return confirm(\"Are you sure you want to delete this book?\")'><i class='fas fa-trash-alt'></i> Delete</a>";
        echo "</td>";
        echo "</tr>";
    }
} else {
    echo "<tr><td colspan='8' class='text-center'>No sold books found</td></tr>";
}
...
function printBooksReport() {
    ...
    document.body.innerHTML = brandLogo + "<h2>Books Sold Report</h2>" + printContent;
    window.print();
