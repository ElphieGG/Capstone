...
<i class="fas fa-book-open"></i>
  <span>LibroCompartir</span>
    ...
    <h2 class="mb-4 d-flex justify-content-between">
       ...
       &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
       &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
       <button class="btn-action"><a href="add_book_status.php" style="color: white; text-decoration: none;">Add Book Status</a></button>
    ...
    <div class="table-responsive">
        <table id="booksTable" class="table table-striped table-hover">
            ...
            <tbody>
                ...
                $sql = "SELECT status_id, book_status
                        FROM tblbook_status";
...
function printBooksReport() {
    ...
    document.body.innerHTML = brandLogo + "<h2>Book Status Report</h2>" + printContent;
    window.print();
