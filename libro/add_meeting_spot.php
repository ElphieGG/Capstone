...
if ($_SERVER["REQUEST_METHOD"] == "POST" ) {
    ...
    $meeting_spot= $conn->real_escape_string($_POST['meeting_spot']);
// Insert into the database
    $sql = "INSERT INTO tblmeetingspot(meeting_spot)  VALUES ('$meeting_spot')";

    if ($conn->query($sql) === TRUE) {
        // Redirect to all_shippingrate.php (ensure no output before this)
       header("Location: meeting_spot.php");
...
<div class="content">
            <h2>Add Meeting Spot</h2>
            <br>
            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" enctype="multipart/form-data">
                <label for="text">Meeting Spot :</label><br>
                <input type="text" id="meeting_spot" name="meeting_spot" required><br>
                ...
                <div style="display: flex; gap: 10px; margin-top: 10px;">
                    ...
                    <a href="meeting_spot.php" class="btn btn-secondary" 
