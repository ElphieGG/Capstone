...
<i class="fas fa-book-open"></i>
  <span>LibroCompartir</span>
    ...
    <h2 class="mb-4 d-flex justify-content-between">
       ...
       &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
       &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
       <button class="btn-action"><a href="add_meeting_spot.php" style="color: white; text-decoration: none;">Add Meeting Spot</a></button>
    ...
    <div class="table-responsive">
        <table id="booksTable" class="table table-striped table-hover">
            ...
            <tbody>
                ...
                $sql = "SELECT meeting_id, meeting_spot
                        FROM tblmeetingspot";
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo "<td>" . $row["meeting_spot"] . "</td>";
                        echo "</tr>";
                    }
                } else {
                    echo "<tr><td colspan='7' class='text-center'>No meeting spot found</td></tr>";
                }
...
function printBooksReport() {
    ...
    document.body.innerHTML = brandLogo + "<h2>Meeting Spot Report</h2>" + printContent;
    window.print();
