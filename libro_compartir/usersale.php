...
<div class="products-box">
    <div class="products-header">
        <h2 style="color: #800000;">My Sale Transactions</h2>
      
    </div>
    <?php
include('config.php'); // ensure you have this included already

$seller_id = $_SESSION['user_id']; // or however you're getting the seller/user ID
$query = "SELECT 
            od.detail_id,
          ...
          LEFT JOIN tblreviews r ON r.user_id = o.user_id AND r.id = b.id
          WHERE b.user_id = ?";
          
$stmt = $conn->prepare($query);
$stmt->bind_param("i", $user_id); // Only 1 user_id now (seller)
$stmt->execute();
...
<div class="book-container">
  ...
  <?php while ($row = $result->fetch_assoc()): ?>
    <tr>
      ...
      <td>
        <img src="data:image/jpeg;base64,<?php echo base64_encode($row['book_image']); ?>" width="50" height="60" />
      </td>
