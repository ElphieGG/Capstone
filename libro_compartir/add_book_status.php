...
if ($_SERVER["REQUEST_METHOD"] == "POST" ) {
    ...
    $book_status = $conn->real_escape_string($_POST['book_status']);
// Insert into the database
    $sql = "INSERT INTO tblbook_status (book_status)  VALUES ('$book_status)";
...
<div class="content">
            <h2>Add Book Status</h2>
            <br>
            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" enctype="multipart/form-data">
                <label for="text">Book Status:</label><br>
                <input type="text" id="book_status" name="book_status" required><br>
                ...
                <div style="display: flex; gap: 10px; margin-top: 10px;">
                    ...
                    <a href="book_status.php" class="btn btn-secondary" 
